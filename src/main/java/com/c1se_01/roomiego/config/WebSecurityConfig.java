    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(request -> request
                        .requestMatchers("/auth/**", "/public/**", "/api/markers","/api/roommates/**","/api/rooms","/api/rooms/{id}","/api/roommates/export-to-file", "/ws/**", "/swagger-ui/**", "/v3/api-docs/**", "/swagger-ui.html", "/health").permitAll() // ✅ Cho phép API này truy cập công khai
